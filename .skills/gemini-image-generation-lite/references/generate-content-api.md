...
|------|-------|
| Method | `POST` |
| Endpoint | `https://app-9wmtpvxmtm9t-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent` |
...
async function generateOrEditImage(
  ...
  const response = await fetch(
    "https://app-9wmtpvxmtm9t-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
