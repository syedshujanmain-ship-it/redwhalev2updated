...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-9wmtpvxmtm9t-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations` |
| Query Task Endpoint | `GET https://app-9wmtpvxmtm9t-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}` |
...
async function createImageTask(params: {
  ...
  const response = await fetch(
    "https://app-9wmtpvxmtm9t-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations",
    {
      method: "POST",
      headers: {
...
async function queryImageTask(taskId: string): Promise<{
  ...
  const response = await fetch(
    `https://app-9wmtpvxmtm9t-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
